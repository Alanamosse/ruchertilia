...
export class MielsComponent implements OnInit {
  ...
  miels: Miel[]= [
    ...
    {
      title: 'Printemps',
      description: 'Ce doux printemps a permis aux abeilles de butiner de nombreuses essences. Le nectar de cloza, de l\'aubépine, de l\'érable et d\'arbres fruitiers composent ce miel atypique.',
